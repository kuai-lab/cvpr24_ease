...
from ease.utils import get_root_logger, save_gt_instances, save_pred_instances
...
def get_args():
    ...
    parser.add_argument('--edge_weight', default=1.0, type=float, help='edge loss weight')
    parser.add_argument('--edge_lambda', default=1.0, type=float, help='edge loss lambda')
